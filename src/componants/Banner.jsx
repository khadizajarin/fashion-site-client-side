...
const Banner = () => {
    return (
        <div className="hero min-screen " style={{backgroundImage: 'url(https://media.istockphoto.com/id/1311055822/photo/hands-aesthetic-on-bright-background-artwork-concept-of-human-relation-community-togetherness.jpg?s=2048x2048&w=is&k=20&c=0VVbpnDFYF9Wo71A_rDegIJFvkHwbpcfwS7MH1ZYs6Q=)'}}>
